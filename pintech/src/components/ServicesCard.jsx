...
const ServicesCard = ({ service, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden max-w-lg m-2 sm:m-6 rounded-xl border border-gray-200 dark:border-gray-700 
    ...
    >
      ...
      <div
        className="flex flex-col items-center sm:flex-row gap-5 p-8 hover:p-7.5 hover:m-0.5 transition-all rounded-[10px] 
